...
//============================================================================
class TheManipulator : public IManipulator
{
public:
  TheManipulator() {}
  virtual ~TheManipulator() {}
...
int main(int argc,char** argv)
{
  ...
  eng.AddLight(light);
  eng.AddLight(light);
  light.SetPosition(StreamCoordinates(3200, 1800, 3300));
  eng.AddLight(light);
  light.SetPosition(StreamCoordinates(2600, 1400, 3100));
  eng.AddLight(light);
  light.SetPosition(StreamCoordinates(2200, 1400, 2500));
  eng.AddLight(light);
  ...
  for (int i=0; i<names.isize(); i++) {
    ...
    stat.SetPosition(StreamCoordinates(a, 589-(1.-kidscale)*70, c));
    ...
    body.SetPosition(StreamCoordinates(a, 530, c));
